...
class EmpleadoBase:
    ...
    def obtener_informacion(self):
        """Devuelve la informacion basica del empleado."""
...
class EmpleadoPlanta(EmpleadoBase):
    ...
    def calcular_pago(self):
        # El empleado de planta recibe salario + 30% de prestaciones
...
class EmpleadoContratista(EmpleadoBase):
    ...
    def calcular_pago(self):
        # El contratista recibe solamente su salario base
...
def salario_promedio(empleados):
    ...
    for empleado in empleados:
        total = total + empleado.salario_base
...
def ejecutar_quiz():
    ...
    for empleado in empleados:
        # POLIMORFISMO: misma llamada, distinto resultado segun el tipo
        print(
